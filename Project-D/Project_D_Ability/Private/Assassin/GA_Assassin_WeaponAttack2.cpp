...
UGA_Assassin_WeaponAttack2::UGA_Assassin_WeaponAttack2() {
	//몽타주 설정
	static ConstructorHelpers::FObjectFinder<UAnimMontage> Montage(TEXT("AnimMontage'/Game/Characters/Player/Assassin/Animation/AM_Assassin_TwoHandAttack_Montage.AM_Assassin_TwoHandAttack_Montage'"));
	if (Montage.Succeeded()) {
		MontageToPlay = Montage.Object;
		UE_LOG(LogTemp, Log, TEXT("Assassin WeaponAttack2 Anim Load Succeess"))
	}
	else {
		UE_LOG(LogTemp, Log, TEXT("Assassin WeaponAttack2 Anim Load Failed"))
	}
...
void UGA_Assassin_WeaponAttack2::ActivateAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo, const FGameplayEventData* TriggerEventData)
{
