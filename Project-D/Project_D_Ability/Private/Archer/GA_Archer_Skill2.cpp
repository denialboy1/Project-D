...
UGA_Archer_Skill2::UGA_Archer_Skill2() {
	...
	if (Montage.Succeeded()) {
		...
		//ÄðÅ¸ÀÓ ¼³Á¤
		CooldownGameplayEffectClass = UGE_Archer_Skill2::StaticClass();
...
void UGA_Archer_Skill2::ActivateAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo, const FGameplayEventData* TriggerEventData)
{
